    ...
    getElementType: function () {
        switch (true) {
            ...
            case (this.element.nodeName.toUpperCase() == 'INPUT'):
                throw new Error('LiveValidation::getElementType - Cannot use LiveValidation on an ' + this.element.type + ' button!');
            default:
...
var Validate = {
    ...
    LoteCP_medio: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        if (value == "N/A") {
            Validate.Format(value, {
            ...
            Validate.Format(value, {
                failureMessage: message,
                pattern: /^[0-9]{1,2}[A-L]{1,1}([0][1-9]|[1-2][0-9]|[3][0-1])|([-]{1,1}[0-9]{1,2})$/i
            });
        }
        return true;
    },
